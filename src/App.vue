<template>
  <nav>
    ...
    <router-link to="/databindingtext">Data Binding Text</router-link> |
    <router-link to="/databindinginputnumber">Data Binding Number</router-link> |
    ...
    <router-link to="/apimixin">API Mixin</router-link> |
